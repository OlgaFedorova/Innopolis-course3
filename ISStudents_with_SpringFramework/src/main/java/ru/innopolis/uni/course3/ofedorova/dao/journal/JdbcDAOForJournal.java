 ...
 */
public class JdbcDAOForJournal implements DAOForJournal {
    ...
    public int add(Journal journal) {
        try (final Connection connection = ConnectionPoolFactory.getConnection();
             final PreparedStatement statement = connection.prepareStatement("INSERT  INTO journal (date_of_record, lecture_id, student_id) VALUES (?, ?, ?)", Statement.RETURN_GENERATED_KEYS)) {
    ...
    public void delete(int id) {
        try (final Connection connection = ConnectionPoolFactory.getConnection();
             final PreparedStatement statement = connection.prepareStatement("DELETE FROM  journal WHERE id = ?")) {
