...
public class ControllerForUsers implements DAOtoUsers {
    ...
    /**
     * Создает новый {@code ControllerForUsers}.
     *
     * @param daOtoUsers     значение поля "daOtoUsers".
     * @param serviceOfUsers значение поля "serviceOfUsers".
     */
    public ControllerForUsers(DAOtoUsers daOtoUsers, ServiceOfUsers serviceOfUsers) {
    ...
    public User addNewUser(String name, String password) throws DAOtoUsersException {
        ...
        return this.daOtoUsers.addNewUser(name, hashAndSalt.get("password"), hashAndSalt.get("salt"));
    }
