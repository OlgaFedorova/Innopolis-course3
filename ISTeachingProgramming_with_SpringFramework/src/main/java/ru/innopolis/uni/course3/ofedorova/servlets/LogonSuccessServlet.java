...
/**
 * Сервлет для отображания информации об успешной авторизации.
 *
 * @author Olga Fedorova
 * @version 1.0
 * @since 26.12.2016
 */
public class LogonSuccessServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/security/success-logon.jsp").forward(req, resp);
    }
}
