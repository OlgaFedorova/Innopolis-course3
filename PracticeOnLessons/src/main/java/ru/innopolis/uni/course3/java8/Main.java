...
import ru.innopolis.uni.course3.java8.parsers.ParserForNumber;
import ru.innopolis.uni.course3.java8.storages.StorageData;
import ru.innopolis.uni.course3.java8.storages.StorageForSumOfPositiveEvenNumbers;
...
public class Main {
    ...
    public static void main(String[] args) {
        ManagerOfProgram managerOfProgram = new ManagerOfProgram(new StorageForSumOfPositiveEvenNumbers(), new ParserForNumber());
